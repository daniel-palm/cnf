...
--  tab stuff
map_key(n, "<A-h>", "<Cmd>tabNext <CR>", default_settings) --next tab
map_key(n, "<A-l>", "<Cmd>tabprevious <CR>", default_settings) --prev tab
map_key(n, "<A-t>", "<ESC>:tabnew ~/", default_settings) --new tab
map_key(n, "<A-q>", "<Cmd>bd <CR>", default_settings) --close tba

-- show dash
map_key(n, "<leader>ds", "<Cmd>Dashboard<CR>", default_settings)
...
map_key(exclude_t, '<leader>f', '<Cmd>Telescope find_files<CR>', default_settings)

-- Toggle the file explorer.
map_key(n, '<leader>t', '<Cmd>NvimTreeToggle<CR>', default_settings)
...
-- Move.
map_key(n, '<S-j>', '<Cmd>BufferMovePrevious<CR>',  default_settings)
map_key(n, '<S-k>', '<Cmd>BufferMoveNext<CR>',  default_settings)

-- Closing.
Close_current_buffer = require 'derp.ui.utils'.close_current_buffer_LV
...
map_key(n, '<M-h>', '<Cmd>BufferPrevious<CR>', default_settings)
map_key(n, '<M-l>', '<Cmd>BufferNext<CR>', default_settings)
...
----------Find & Replace------------
map_key(n, "<leader>re", "<ESC>:%s/foo/bar/g", default_settings)
